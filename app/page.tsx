...
import { monofocalCatalog } from "@/data/catalog/company/tecni-optica-catalog";
const MainPage = () => {
  ...
  return (
    <section className="h-full w-full p-5  flex flex-col gap-8 justify-center items-center">
      ...
      <article className="text-center w-2/3 flex flex-col gap-8 items-center ">
        ...
        <p>Conceptos claros, ejemplos reales y explicaciones simples para aprender más rápido el trabajo diario</p>
      </article>
    </section>
  );
}
