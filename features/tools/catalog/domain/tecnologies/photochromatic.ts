...
export const PHOTOCHROMATIC_LENSES_CATALOG: PhotochromaticCatalog = {
  ...
  TransitionsGen8: {
    ...
    photochromaticName: "Transitions G8",
    photochromaticBrand: "Varilux",
    photochromaticGeneration: "Gen 8",
    photochromaticColors: [
      "Gris",
      "Marrón",
      "Verde",
      "Zafiro",
  ...
  TransitionsXTRActive: {
    ...
    photochromaticFeatures: [
      "Oscurece detrás del parabrisas",
      "Mayor protección contra luz intensa",
    ],
  ...
  KodakAcclimate: {
    photochromaticItemId: "K1",
    photochromaticName: "Kodak Acclimate",
    ...
    photochromaticFeatures: [
      "Transición suave de interiores a exteriores",
      "Bloqueo total de rayos UVA y UVB",
      "Excelente relación costo-beneficio",
      "Compatible con Blue UV y tratamientos Crizal"
    ],
    photochromaticPolarized: false,
  },
