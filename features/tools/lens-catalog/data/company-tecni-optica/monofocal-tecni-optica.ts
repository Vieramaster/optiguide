...
export const MONOFOCAL_TECNI_OPTICA: LensArrayCatalog[] = [
    ...
    { key: "orma7-clook-bcut", lens: "orma7", treatment: ["ClearLook", "BlueCut"] },
    { key: "orma7-clsupra-bcut", lens: "orma7", treatment: ["ClearLookSupra", "BlueCut"] },

    { key: "orma12-trans-grey", lens: "orma12", photochromatic: "TransitionsGenSGrey" },
    { key: "orma13-trans-colors", lens: "orma13", photochromatic: "TransitionsGenSColors" },
