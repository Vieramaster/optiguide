# Cristales y sus indices de refracción

El **índice de una lente** indica qué tan gruesa o delgada será y refleja la capacidad del material para desviar la luz. También se conoce como **índice de refracción** o **índice refractivo**. Se expresa mediante un número que compara la velocidad de la luz en el aire con su velocidad dentro del material de la lente.  
Un índice más alto significa que la luz se desvía más al atravesar la lente, permitiendo corregir la misma graduación con menos material. Por ello, **las lentes de alto índice son más delgadas y livianas** que las convencionales de vidrio o plástico, mientras que las de índice bajo tienden a ser más gruesas y pesadas. Este principio es especialmente útil para personas con graduaciones elevadas, ya que reduce el grosor y el peso de los lentes sin comprometer la corrección visual.  
...
- Material orgánico (resina ADC).
- Adecuado para graduaciones bajas a moderadas (aprox. ±2.00 dioptrías por estética).
- De buena calidad óptica y baja distorsión.
- Económico y funcional como primera opción.
- No recomendado para monturas perforadas o con borde al aire.

### Datos del material

- Nombre químico: Allyl Diglycol Carbonate (ADC).

- Alto valor Abbe (≈58), lo que reduce aberraciones y mejora la nitidez.
- Liviano en comparación con el vidrio.
- Se raya con relativa facilidad si no tiene [tratamiento anti rayas](/articulos/tratamiento-anti-rayas).
- Buena aceptación de tratamientos: [antirreflejo](/articulos/antirreflejante), [filtro azul](/articulos/filtro-azul), endurecido y coloraciones de tinte.
...
- Excelente resistencia al rayado, incluso sin [tratamiento anti rayas](/articulos/tratamiento-anti-rayas).
...
- Valor Abbe ≈ 59 (definición y colores con mínima aberración).
- Delgado en relación al CR-39, pero pesado en monturas grandes.
- Coloraciones profundas y estables.
- Se utiliza por exigencia estética, uso de laboratorio o preferencia personal.
...
- Material orgánico de alta resistencia al impacto.
- Calidad óptica superior al policarbonato (mejor nitidez periférica).
- Adecuado para graduaciones bajas a moderadas (aprox. hasta ±3.00 por estética).
- Recomendado para niños, deportes, seguridad laboral y usuarios activos.
- Ideal para monturas al aire o perforadas por su estabilidad estructural.
...
- Acepta sin inconvenientes [antirreflejo](/articulos/antirreflejante), [tratamiento anti rayas](/articulos/tratamiento-anti-rayas) y filtros.
...
- MR-8 (Mitsui) — la resina más habitual para 1.56.
- MR-7 (Mitsui) — variante usada por algunos laboratorios.
- Resina 1.56 genérica — formulaciones sin marca que ofrecen muchos fabricantes.
- Nombres comerciales de fabricantes (p. ej. Hoya 1.56, Zeiss 1.56, Essilor 1.56) — marcas propias que usan fórmulas MR o variantes licenciadas.
- Resinite / otras series de marca — nombres comerciales que pueden aparecer según el proveedor o laboratorio.

### Características principales

- Material orgánico de alto índice (más delgado que CR-39).
- Adecuado para graduaciones moderadas y algunas altas (aprox. ±3.00 a ±4.00 por estética).
- Buena claridad visual y rendimiento óptico.
- Mejor estética en recetas miopes (reduce grosor en bordes) y hipermetropía (disminuye el “efecto lupa”).
- Compatible con la mayoría de tipos de monturas.
...
- Acepta sin problema tratamientos: [antirreflejo](/articulos/antirreflejante), [anti rayas](/articulos/tratamiento-anti-rayas), [filtro azul](/articulos/filtro-azul) y coloraciones por tinte.
...
- Material orgánico de alta resistencia al impacto.
- Calidad óptica superior al policarbonato (menos aberración lateral).
- Graduaciones recomendadas: moderadas a altas (aprox. de ±2.00 a ±5.00 por estética).
- Adecuado para niños, seguridad, deportes y monturas al aire.
- Sensación de ligereza para uso diario.
- Opción equilibrada entre seguridad y visión.
...
- Acepta bien [antirreflejo](/articulos/antirreflejante), [filtro azul](/articulos/filtro-azul) y [tratamiento anti rayas](/articulos/tratamiento-anti-rayas).
...
- Más delgado y estético que el vidrio 1.52.
- Excelente claridad óptica.
- Resistente al rayado de forma natural.
- Pesado en comparación con los materiales orgánicos.
- Riesgo de rotura ante impactos o golpes.

### Datos del material

- Valor Abbe muy alto, con nitidez y mínima aberración cromática.
- Reducción de grosor visible frente al 1.52.
- Buena estabilidad en coloraciones.
- Elección puntual en monturas completas, no recomendable en al aire o perforadas.

### Resina de Alto Índice

Es un material de alto índice diseñado para reducir significativamente el grosor de la lente frente a CR-39 (1.50) y 1.56. Esto se traduce en una mejora estética notable, especialmente en recetas de [miopía](/articulos/miopia) o [hipermetropías](/articulos/hipermetropia) más marcadas, evitando bordes gruesos o el efecto lupa.
...
- MR-8 (Mitsui – Japón)
- MR-10 (Mitsui – Japón)
- Phoenix Trivex de alto índice (PPG – en versiones específicas)
- Resinas HRI (High Refractive Index) utilizadas por fábricas chinas e internacionales sin marca definida
...
- Reduce de manera visible el grosor en miopes y el aumento en [hipermetropías](/articulos/hipermetropia).
...
- Acepta correctamente [antirreflejo](/articulos/antirreflejante), [filtro azul](/articulos/filtro-azul) y [anti rayas](/articulos/tratamiento-anti-rayas).
- Recomendado siempre con [antirreflejo](/articulos/antirreflejante) por mayor reflejo que índices bajos.
...
- MR-16 (Mitsui – Japón)
- Hoya EYAS 1.67 (Hoya)
- Resinas HRI de 1.67 utilizadas por fabricantes asiáticos e internacionales
...
- Reduce de forma muy notable el grosor en [miopía](/articulos/miopia), evitando bordes marcados.
- Disminuye el efecto lupa en [hipermetropías](/articulos/hipermetropia) y lentifica la distorsión visual.
...
- Necesita [antirreflejo](/articulos/antirreflejante) debido a su mayor índice y reflejos visibles.
- Compatible con filtros especiales como [filtro azul](/articulos/filtro-azul), [filtro UV](/articulos/filtro-ultravioleta), [fotocromáticos](/articulos/fotocromaticos) y [antirreflejante](/articulos/antirreflejante) premium.
...
Es un material mineral de alto índice diseñado para obtener lentes considerablemente más delgados que el vidrio 1.52 y 1.60. Es elegido principalmente por motivos estéticos en graduaciones altas, ya que reduce notablemente el borde en [miopías](/articulos/miopia) fuertes y el efecto lupa en [hipermetropías](/articulos/hipermetropia).
...
- Mucho más delgado que el vidrio tradicional.
- Máxima nitidez y mínima aberración cromática.
- Resistente al rayado sin tratamientos.
- Pesado pese a ser más fino.
- Riesgo de rotura mayor comparado con cualquier resina.

### Datos del material

- Valor Abbe muy alto.
- Notable reducción del grosor frente a 1.52 y 1.60.
- Buena respuesta en coloraciones.
- Recomendado en monturas completas y uso cuidado.

### Resina de Alto Índice

La resina índice 1.70 se fabrica para reemplazar al vidrio en casos de graduaciones altas donde la estética es prioridad. Permite una reducción de grosor importante con un peso menor que el mineral, manteniendo una buena claridad óptica.
Suele considerarse una opción premium, utilizada por quienes desean lentes finos sin saltar al costo más elevado del índice 1.74.

### Resinas y nombres comerciales utilizados para este índice:

- MR-7 HRI (Mitsui)
- MR-10 HRI (variantes para tratamientos específicos)
- Resinas HRI de fabricantes chinos e internacionales

### Características principales

- Material orgánico de alto índice (más delgado que 1.60 y 1.56).
...
- Mayor reflejo superficial, recomendable usar [antirreflejo](/articulos/antirreflejante) siempre.

### Datos del material

- Valor Abbe aprox. 30–36.
- Resistencia al impacto similar o menor que 1.60.
- Menos flexible, se debe evitar perforadas en algunos modelos.
- Muy buena estética general sin llegar al costo del 1.74.
...
- MR-174 (Mitsui – Japón)
- Resinas HRI (High Refractive Index) utilizadas por laboratorios internacionales y fabricantes sin marca.
- Versiones propias de marcas premium (como Essilor, Zeiss, Hoya) basadas en licencias o fórmulas derivadas.

### Características principales

- Material orgánico de altísimo índice, el más delgado en el mercado.
...
- Requiere sí o sí [antirreflejo](/articulos/antirreflejante) por el alto reflejo de la superficie.
...
- Acepta [antirreflejo](/articulos/antirreflejante), [anti rayas](/articulos/tratamiento-anti-rayas) y [filtro azul](/articulos/filtro-azul); no siempre recomendado para coloraciones profundas.
...
Rrepresentan el nivel más extremo en reducción de grosor dentro de la producción de lentes. Son diseñados exclusivamente para graduaciones muy altas, donde la prioridad es la estética y la disminución máxima del borde en [miopías](/articulos/miopia) severas o del efecto lupa en hipermetropías avanzadas.

### Son materiales muy raros en el mercado, producidos por pocos fabricantes y utilizados en situaciones puntuales como:

- Prescripciones extremadamente altas.
- Pacientes acostumbrados al vidrio que no desean cambiar a resina.
- Lentes para uso profesional o de laboratorio.
- Casos en los que el costo no es un factor limitante.
- A pesar de su delgadez, siguen siendo pesados, y su resistencia a impacto continúa siendo baja, por lo que no son una opción recomendada para el uso cotidiano promedio.

### Características principales

- Los materiales más delgados dentro de la categoría mineral.
- Claridad óptica excelente y aberración cromática mínima.
- Muy pesados en relación al tamaño del lente.
- Alto riesgo de rotura ante golpes o caídas.
- Extremadamente específicos: uso reducido y disponibilidad limitada.

### Datos del material

- Valor Abbe muy alto.
- Reducción de espesor máxima frente a todos los demás índices.
- Ideales solo en monturas completas.
...
<table>
  <cristales>
    <tr>
      <th>Índice</th>
      <th>Material</th>
      <th>Grosor (comparado con 1.50)</th>
      <th>Peso</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Base</td>
      <td>Ligero</td>
      <td>Recetas bajas a medias</td>
    </tr>
    <tr>
      <td>1.52</td>
      <td>Vidrio mineral</td>
      <td>~0% más fino</td>
      <td>Pesado</td>
      <td>Alta claridad, uso específico</td>
    </tr>
    <tr>
      <td>1.53</td>
      <td>Vidrio mineral</td>
      <td>~5% más fino que 1.52</td>
      <td>Pesado</td>
      <td>Alta claridad, uso estético específico</td>
    </tr>
    <tr>
      <td>1.56</td>
      <td>Resinas MR-8 / MR-7</td>
      <td>~15% más fino</td>
      <td>Ligero</td>
      <td>Graduaciones medias</td>
    </tr>
    <tr>
      <td>1.59</td>
      <td>Policarbonato</td>
      <td>~20% más fino</td>
      <td>Muy ligero</td>
      <td>Niños, deportivos, seguridad</td>
    </tr>
    <tr>
      <td>1.60</td>
      <td>Resinas MR-10 / MR-8</td>
      <td>~25% más fino</td>
      <td>Ligero</td>
      <td>Miopías moderadas</td>
    </tr>
    <tr>
      <td>1.67</td>
      <td>Resinas MR-7 / MR-8</td>
      <td>~35% más fino</td>
      <td>Ligero</td>
      <td>Miopías altas</td>
    </tr>
    <tr>
      ...
      <td>~40% más fino</td>
      <td>Pesado</td>
      <td>Alta nitidez, uso específico</td>
    </tr>
    <tr>
      <td>1.74</td>
      <td>Resinas MR-174</td>
      <td>~45% más fino</td>
      <td>Muy ligero</td>
      <td>Muy alta graduación</td>
    </tr>
    <tr>
      <td>1.80 (mineral)</td>
      <td>Vidrio</td>
